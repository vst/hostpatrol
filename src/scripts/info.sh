...
_print_var "LHP_KERNEL_NAME" "$(uname -s)"
_print_var "LHP_KERNEL_NODE" "$(uname -n)"
_print_var "LHP_KERNEL_RELEASE" "$(uname -r)"
_print_var "LHP_KERNEL_VERSION" "$(uname -v)"
_print_var "LHP_KERNEL_MACHINE" "$(uname -m)"
_print_var "LHP_KERNEL_OS" "$(uname -o)"
_print_var "LHP_APP_DOCKER" "$(_which_command "docker" || _which_command "podman" || echo "")"
_print_var "LHP_APP_SCREEN" "$(_which_command "screen" || echo "")"
_print_var "LHP_APP_TMUX" "$(_which_command "tmux" || echo "")"
sed "s/^/LHP_DISTRO_/g" /etc/os-release
